...
#'
#' This function returns the density of a bivariate conditional copula, where
...
#' gamBiCopPDF(fit$res)
#' @export
gamBiCopPDF <- function(object, newdata = NULL) {
  ...
  out <- as.numeric(bicoppd1d2(data, object@family))
